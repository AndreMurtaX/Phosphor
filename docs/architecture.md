...
Phosphor/
  ...
  scripts/
    ...
    check-seams.py check-codepage.py check-budget.py check-manifests.py
                        the EIGHT gates test-suite runs after the corpora: every
                        ...
                        budget, and every .bas in a manifest-driven corpus
                        listed in that manifest. coverage.py counts this many against what
