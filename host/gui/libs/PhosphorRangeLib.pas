...
var c: TComponent; begin E := NoError; if GuiResolve(A[0].Hnd, TTrackBar, c) then TTrackBar(c).Min := Round(AsDouble(A[1])); Result := A[0]; end;
...
var c: TComponent; begin E := NoError; if GuiResolve(A[0].Hnd, TTrackBar, c) then TTrackBar(c).Max := Round(AsDouble(A[1])); Result := A[0]; end;
...
var c: TComponent; begin E := NoError; if GuiResolve(A[0].Hnd, TTrackBar, c) then TTrackBar(c).Position := Round(AsDouble(A[1])); Result := A[0]; end;
...
var c: TComponent; begin E := NoError; if GuiResolve(A[0].Hnd, TProgressBar, c) then TProgressBar(c).Min := Round(AsDouble(A[1])); Result := A[0]; end;
...
var c: TComponent; begin E := NoError; if GuiResolve(A[0].Hnd, TProgressBar, c) then TProgressBar(c).Max := Round(AsDouble(A[1])); Result := A[0]; end;
...
var c: TComponent; begin E := NoError; if GuiResolve(A[0].Hnd, TProgressBar, c) then TProgressBar(c).Position := Round(AsDouble(A[1])); Result := A[0]; end;
...
var c: TComponent; begin E := NoError; if GuiResolve(A[0].Hnd, TScrollBar, c) then TScrollBar(c).Min := Round(AsDouble(A[1])); Result := A[0]; end;
...
var c: TComponent; begin E := NoError; if GuiResolve(A[0].Hnd, TScrollBar, c) then TScrollBar(c).Max := Round(AsDouble(A[1])); Result := A[0]; end;
...
var c: TComponent; begin E := NoError; if GuiResolve(A[0].Hnd, TScrollBar, c) then TScrollBar(c).Position := Round(AsDouble(A[1])); Result := A[0]; end;
